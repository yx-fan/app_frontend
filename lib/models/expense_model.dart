class Expense {
  ...
  factory Expense.fromJson(Map<String, dynamic> json) {
    return Expense(
      ...
      date: DateTime.parse(json['date'] ?? DateTime.now().toIso8601String()),  // Default to current time
      ...
      latitude: (json['latitude'] ?? 0.0).toDouble(),  // Ensure latitude is a double
      longitude: (json['longitude'] ?? 0.0).toDouble(),  // Ensure longitude is a double
    );
  }
